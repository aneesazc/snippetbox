...
// for our form fields. Add a new NonFieldErrors []string field to the struct, which we will use to
...
// Valid() returns true if the FieldErrors and NonFieldErrors slice doesn't contain any entries .
